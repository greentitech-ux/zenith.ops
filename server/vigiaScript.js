...
function montarScriptVigia({ codigo, posto, tipo, agentToken, noPulsoPrint, windowsAntigo, ehServidor, unidadeNome, maquinaNome }) {
  ...
  const linhasComuns = [
    ...
    '  $alvo = if ($operador -ieq $env:USERNAME) { "HKCU:\\" + $chaveRel } else { $sid = Sid-DoUsuario $operador; if ($sid) { "Registry::HKEY_USERS\\" + $sid + "\\" + $chaveRel } else { $null } }',
