...
function montarScriptVigia({ codigo, posto, tipo, agentToken, noPulsoPrint }) {
  ...
  const linhasComuns = [
    ...
    '          $caneta = New-Object System.Drawing.Pen([System.Drawing.Color]::Red, 3)',
    ...
    '        $form.Tag = @{ inicio = $null; area = $null; acao = "salvar"; ferramenta = "selecao"; marcas = (New-Object System.Collections.ArrayList); marcaAtual = $null }',
    ...
    '        $acoes=New-Object System.Windows.Forms.Panel; $acoes.Size=New-Object System.Drawing.Size(410,42); $acoes.BackColor=[System.Drawing.Color]::FromArgb(30,36,45); $acoes.Location=New-Object System.Drawing.Point(([Math]::Max(14,[int](($form.ClientSize.Width-410)/2))),($form.ClientSize.Height-56))',
    ...
    '        $acoes.Controls.AddRange(@($btSeta,$btLinha,$btCaixa,$copiar,$salvar,$fechar));$form.Controls.Add($acoes)',
