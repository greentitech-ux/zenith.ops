...
function montarScriptVigia({ codigo, posto, tipo, agentToken, noPulsoPrint }) {
  ...
  const linhasComuns = [
    ...
    '    param($CaminhoAtivo, $PastaBase, $CaminhoLogPrint, $CaminhoErro)',
    ...
    '    }',
    '  }).AddArgument($CaminhoNoPulsoPrintAtivo).AddArgument($PastaNoPulsoPrint).AddArgument($CaminhoLog).AddArgument($CaminhoNoPulsoPrintErro)',
    ...
    '  if ($estado -eq "Running") { return "pronto" }',
    '  $motivo = ""',
