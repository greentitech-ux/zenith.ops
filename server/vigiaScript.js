...
function montarScriptVigia({ codigo, posto, tipo, agentToken, noPulsoPrint }) {
  ...
  const linhasComuns = [
    ...
    '      function Selecionar-AreaPrint($tela) {',
    ...
    '        $form.Tag = @{ inicio = $null; area = $null; acao = "salvar"; ferramenta = "selecao"; marcas = (New-Object System.Collections.ArrayList); marcaAtual = $null; corMarca = [System.Drawing.Color]::Red; grossuraMarca = 3 }',
    ...
    '            $grafico.Dispose()',
    '            $escolhaPrint = Selecionar-AreaPrint $tela',
