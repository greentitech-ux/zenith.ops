...
function montarScriptVigia({ codigo, posto, tipo, agentToken, noPulsoPrint }) {
  ...
  const linhasComuns = [
    ...
    '        $acoes=New-Object System.Windows.Forms.Panel; $acoes.Size=New-Object System.Drawing.Size(205,42); $acoes.BackColor=[System.Drawing.Color]::FromArgb(30,36,45); $acoes.Location=New-Object System.Drawing.Point([Math]::Max(14,[int](($form.ClientSize.Width-205)/2)),$form.ClientSize.Height-56)',
    ...
    '        $salvar=New-Object System.Windows.Forms.Button; $salvar.Text="Salvar"; $salvar.Size=New-Object System.Drawing.Size(92,30); $salvar.Location=New-Object System.Drawing.Point(106,6); $salvar.BackColor=[System.Drawing.Color]::GreenYellow; $salvar.Add_Click({param($botao,$e);$janela=$botao.Parent.Parent;if($janela.Tag.area -and $janela.Tag.area.Width -ge 3 -and $janela.Tag.area.Height -ge 3){$janela.Tag.resultado=$janela.Tag.area;$janela.DialogResult=[System.Windows.Forms.DialogResult]::OK;$janela.Close()}}); $acoes.Controls.AddRange(@($cancelar,$salvar));$form.Controls.Add($acoes)',
    '        $form.Add_KeyDown({ param($s, $e) if($e.KeyCode -eq [System.Windows.Forms.Keys]::Escape){$s.Tag.resultado=$null;$s.Close();return};if($e.KeyCode -eq [System.Windows.Forms.Keys]::Enter -and $s.Tag.area){$s.Tag.resultado=$s.Tag.area;$s.DialogResult=[System.Windows.Forms.DialogResult]::OK;$s.Close();return};if($s.Tag.area){$passo=if($e.Shift){10}else{1};switch($e.KeyCode){Left{$s.Tag.area.X-=$passo};Right{$s.Tag.area.X+=$passo};Up{$s.Tag.area.Y-=$passo};Down{$s.Tag.area.Y+=$passo};default{return}};$s.Invalidate();$e.Handled=$true} })',
    ...
    '            $grafico.Dispose()',
    '            $areaSelecionada = Selecionar-AreaPrint $tela',
    '            if (-not $areaSelecionada) { $imagem.Dispose(); continue }',
    '            $recorte = $imagem.Clone($areaSelecionada, $imagem.PixelFormat)',
    '            $imagem.Dispose()',
