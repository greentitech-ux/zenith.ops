...
function montarScriptVigia({ codigo, posto, tipo, agentToken }) {
  ...
  const linhasComuns = [
    ...
    '# PASSIVA: so le a tabela de vizinhos (ARP) que o Windows ja mantem de',
    '# quem esse computador conversou na rede da loja. NAO dispara pacote pra',
    '# ninguem - nao vira scanner, nao acorda o IDS do shopping e nao gasta',
    '# banda de um link que ja pode estar ruim.',
