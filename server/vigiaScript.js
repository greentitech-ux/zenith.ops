...
function montarScriptVigia({ codigo, posto, tipo, agentToken, noPulsoPrint, windowsAntigo }) {
  ...
  const linhasComuns = [
    ...
    '    if (-not $dono) {',
    '      # 20 s e a copia antiga nao soltou: ela travou (dialogo modal, runspace',
    '      # preso). A copia NOVA vence - e a versao mais recente e e quem tem',
    '      # que ficar. Encerra a antiga e assume; so desiste se nem assim.',
    '      Escrever-Log "Outra instancia ($papel) segura o mutex ha 20s - encerrando a antiga pra esta assumir."',
