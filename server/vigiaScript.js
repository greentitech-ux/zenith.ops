...
function montarScriptVigia({ codigo, posto, tipo, agentToken, noPulsoPrint }) {
  ...
  const linhasLoopInterno = [
    ...
    '        $cancelar=New-Object System.Windows.Forms.Button; $cancelar.Text="Cancelar"; $cancelar.Size=New-Object System.Drawing.Size(92,30); $cancelar.Location=New-Object System.Drawing.Point(7,6); $cancelar.Add_Click({$form.Tag.resultado=$null;$form.Close()})',
    '        $salvar=New-Object System.Windows.Forms.Button; $salvar.Text="Salvar"; $salvar.Size=New-Object System.Drawing.Size(92,30); $salvar.Location=New-Object System.Drawing.Point(106,6); $salvar.BackColor=[System.Drawing.Color]::GreenYellow; $salvar.Add_Click({if($form.Tag.area -and $form.Tag.area.Width -ge 3 -and $form.Tag.area.Height -ge 3){$form.Tag.resultado=$form.Tag.area;$form.DialogResult=[System.Windows.Forms.DialogResult]::OK;$form.Close()}}); $acoes.Controls.AddRange(@($cancelar,$salvar));$form.Controls.Add($acoes)',
