...
const COMANDO_RESET_SENHA = [
  'try {',
  '  # Pega o primeiro usuario local que nao e sistema',
  ...
  '  ',
  '  if ($usuario) {',
  '    # Gera senha: 16 chars, so numeros + letras minusculas (evita problemas)',
  '    $charset = "abcdefghijklmnopqrstuvwxyz0123456789"',
  '    $senha = ""',
  '    1..16 | ForEach-Object { $senha += $charset.Substring((Get-Random -Maximum $charset.Length), 1) }',
  '    ',
  '    # Usa WMI para resetar (mais confiavel que net user)',
